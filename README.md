...
$$
\begin{aligned}
\langle k \rvertH_\mathrm{intra} \lvert k \rangle 
...
$$
\begin{aligned}
\langle k \rvertH_\mathrm{inter} \lvert k \rangle 
...
\begin{aligned}
  H(k) 
  &:= \langle k \rvertH \lvert k \rangle \\
  &= \langle k \rvertH_\mathrm{intra} + H_\mathrm{inter} \lvert k \rangle \\
